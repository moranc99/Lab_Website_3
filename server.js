...
app.get('/player_info/select_player', function(req, res) {
   // var player = 'select id, name from football_players';
   // var playerInfo = "select * from football_players where id='" + req.query.player_choice + "';";
   // var numGames = 'select count(*) from football_games inner join football_players on football_players.id in (football_games.players[1], football_games.players[2], football_games.players[3], football_games.players[4], football_games.players[5]) = True where id="' + req.query.player_choice + '";';
